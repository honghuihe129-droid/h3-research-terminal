...
const i18n = {
  "en-US": {
    ...
    bottomMonitorTitle: "Bottom Reversal Monitor",
    bottomMonitorSub: "rate / low retest / breadth",
    bottomOverallWatch: "Bottom probability rising, reversal unconfirmed",
    bottomOverallConfirmed: "Reversal confirmation improving",
    bottomOverallRisk: "Bottom thesis not confirmed",
    bottomStatusConfirm: "CONFIRM",
    bottomStatusWatch: "WATCH",
    bottomStatusRisk: "RISK",
    bottomNextCheck: "Next check",
    ...
    underpricedTitle: "Underpriced Core Candidates",
    underpricedSub: "low-position / evidence-gated / upgrade path",
    underpricedPrice: "Price position",
    underpricedEvidence: "Evidence",
    underpricedCatalyst: "Catalyst",
    underpricedUpgrade: "Upgrade gate",
    underpricedInvalidation: "Invalidation",
    underpricedBoundary: "Not in Research Pool yet; upgrade requires fresh evidence",
    underpricedSource: "Source",
    thCompany: "Company",
    thChain: "Chain",
    ...
    policyStatus: "Post-FOMC tracking",
    policyRead: "The Sep 16 Warsh-led FOMC decision is now an input, not a future event: track how yields, USD/JPY, the dollar, and gold absorb the higher rate path",
    ...
    policyFomcRead: "Warsh-led FOMC raised the target range by 25bp to 3.75%-4.00%; the next test is whether yields and the dollar keep tightening financial conditions",
    ...
    policyOutcomeValue: "Hike absorbed vs rates squeeze",
    policyOutcomeRead: "If 2Y/10Y yields cool after the hike, duration and gold can stabilize; if yields and the dollar keep rising, gold and yen remain under pressure",
  ...
  "zh-CN": {
    ...
    verdictAction: "\u7814\u7a76\u52a8\u4f5c",
    verdictMacro: "\u5b8f\u89c2\u95f8\u95e8",
    bottomMonitorTitle: "\u5e95\u90e8\u53cd\u8f6c\u76d1\u63a7",
    bottomMonitorSub: "\u5229\u7387 / \u4f4e\u70b9\u56de\u6d4b / \u5bbd\u5ea6",
    bottomOverallWatch: "\u5e95\u90e8\u6982\u7387\u4e0a\u5347\uff0c\u53cd\u8f6c\u5c1a\u672a\u786e\u8ba4",
    bottomOverallConfirmed: "\u53cd\u8f6c\u786e\u8ba4\u5ea6\u6539\u5584",
    bottomOverallRisk: "\u5e95\u90e8\u5047\u8bbe\u5c1a\u672a\u786e\u8ba4",
    bottomStatusConfirm: "\u786e\u8ba4",
    bottomStatusWatch: "\u89c2\u5bdf",
    bottomStatusRisk: "\u98ce\u9669",
    bottomNextCheck: "\u4e0b\u4e00\u68c0\u67e5",
    ...
    frameworkFlowTitle: "Hypothesis Flow",
    frameworkFlowSub: "news to investable hypothesis",
    underpricedTitle: "\u4f4e\u4f4d\u6838\u5fc3\u5019\u9009",
    underpricedSub: "\u4f4e\u4f4d / \u8bc1\u636e\u95f8\u95e8 / \u5347\u7ea7\u8def\u5f84",
    underpricedPrice: "\u4ef7\u683c\u4f4d\u7f6e",
    underpricedEvidence: "\u8bc1\u636e",
    underpricedCatalyst: "\u50ac\u5316",
    underpricedUpgrade: "\u5347\u7ea7\u95f8\u95e8",
    underpricedInvalidation: "\u8bc1\u4f2a",
    underpricedBoundary: "\u5c1a\u672a\u8fdb\u5165\u6b63\u5f0f\u7814\u7a76\u6c60\uff1b\u5347\u7ea7\u9700\u8981\u65b0\u8bc1\u636e",
    underpricedSource: "\u6765\u6e90",
    thCompany: "\u516c\u53f8",
    thChain: "\u73af\u8282",
    thEvidence: "\u8bc1\u636e\u7b49\u7ea7",
    thLatest: "\u6700\u65b0\u9a8c\u8bc1",
    ...
    policyStatus: "FOMC \u540e\u8ddf\u8e2a",
    policyRead: "9 \u6708 16 \u65e5\u7531 Warsh \u4e3b\u6301\u7684 FOMC \u51b3\u8bae\u5df2\u7ecf\u662f\u8f93\u5165\u53d8\u91cf\uff0c\u4e0d\u518d\u662f\u672a\u6765\u4e8b\u4ef6\uff1b\u63a5\u4e0b\u6765\u770b\u7f8e\u503a\u3001USD/JPY\u3001\u7f8e\u5143\u548c\u9ec4\u91d1\u5982\u4f55\u6d88\u5316\u66f4\u9ad8\u5229\u7387\u8def\u5f84",
    ...
    policyScenario: "\u60c5\u666f\u5730\u56fe",
    policyFomcRead: "Warsh \u4e3b\u6301\u7684 FOMC \u5df2\u52a0\u606f 25bp \u81f3 3.75%-4.00%\uff1b\u4e0b\u4e00\u4e2a\u68c0\u9a8c\u662f\u7f8e\u503a\u5229\u7387\u548c\u7f8e\u5143\u662f\u5426\u7ee7\u7eed\u6536\u7d27\u91d1\u878d\u6761\u4ef6",
    ...
    policyOutcomeValue: "\u52a0\u606f\u88ab\u6d88\u5316 vs \u5229\u7387\u518d\u6324\u538b",
    policyOutcomeRead: "\u5982\u679c 2Y/10Y \u7f8e\u503a\u5728\u52a0\u606f\u540e\u964d\u6e29\uff0c\u957f\u4e45\u671f\u8d44\u4ea7\u548c\u9ec4\u91d1\u53ef\u4ee5\u7a33\u5b9a\uff1b\u5982\u679c\u5229\u7387\u548c\u7f8e\u5143\u7ee7\u7eed\u4e0a\u884c\uff0c\u9ec4\u91d1\u548c\u65e5\u5143\u4ecd\u6709\u538b\u529b",
...
const zhValueTranslations = {
  ...
  "Last verified: FY2027 Q1 revenue USD 81.615B, about +85% YoY, gross margin around 74.9%; next check is FY2027 Q2 data-center revenue and margin guidance": "\u5df2\u9a8c\u8bc1\uff1aFY2027 Q1 \u6536\u5165 816.15 \u4ebf\u7f8e\u5143\uff0c\u540c\u6bd4\u7ea6 +85%\uff0c\u6bdb\u5229\u7387\u7ea6 74.9%\uff1b\u4e0b\u4e00\u6b65\u68c0\u67e5 FY2027 Q2 \u6570\u636e\u4e2d\u5fc3\u6536\u5165\u548c\u6bdb\u5229\u7387\u6307\u5f15",
  "Last verified: FY2026 Q2 revenue USD 22.187B; AI semiconductor revenue USD 10.8B, +143% YoY; next check is FY2026 Q3 AI revenue and networking orders": "\u5df2\u9a8c\u8bc1\uff1aFY2026 Q2 \u6536\u5165 221.87 \u4ebf\u7f8e\u5143\uff1bAI \u534a\u5bfc\u4f53\u6536\u5165 108 \u4ebf\u7f8e\u5143\uff0c\u540c\u6bd4 +143%\uff1b\u4e0b\u4e00\u6b65\u68c0\u67e5 FY2026 Q3 AI \u6536\u5165\u548c\u7f51\u7edc\u8ba2\u5355",
  "FY2026 Q3 remains the HBM/DRAM validation anchor; the conclusion is cycle-sensitive and must be checked against ASP, inventory, and long-term agreement pricing": "FY2026 Q3 \u4ecd\u662f HBM/DRAM \u9a8c\u8bc1\u951a\u70b9\uff1b\u7ed3\u8bba\u5177\u6709\u5468\u671f\u654f\u611f\u6027\uff0c\u5fc5\u987b\u7ee7\u7eed\u68c0\u67e5 ASP\u3001\u5e93\u5b58\u548c\u957f\u534f\u4ef7",
  "2026H1 revenue RMB 41.778B, +182.49% YoY; net profit RMB 13.651B, +241.70%; optical-module gross margin 46.59%": "2026H1 \u6536\u5165 417.78 \u4ebf\u5143\uff0c\u540c\u6bd4 +182.49%\uff1b\u51c0\u5229 136.51 \u4ebf\u5143\uff0c\u540c\u6bd4 +241.70%\uff1b\u5149\u6a21\u5757\u6bdb\u5229\u7387 46.59%",
  "2026H1 revenue RMB 2.828B, +15.15% YoY; net profit RMB 1.204B, +33.92%; passive optical devices grew +77.00%": "2026H1 \u6536\u5165 28.28 \u4ebf\u5143\uff0c\u540c\u6bd4 +15.15%\uff1b\u51c0\u5229 12.04 \u4ebf\u5143\uff0c\u540c\u6bd4 +33.92%\uff1b\u65e0\u6e90\u5149\u5668\u4ef6\u589e\u957f +77.00%",
  "2026H1 official report still needs exchange-level refresh in H^3; keep Q1 high-growth thesis under order, collection, and expense-ratio verification": "2026H1 \u5b98\u65b9\u62a5\u544a\u4ecd\u9700\u5728 H^3 \u4e2d\u505a\u4ea4\u6613\u6240\u7ea7\u522b\u590d\u6838\uff1b\u6682\u4ee5 Q1 \u9ad8\u589e\u5047\u8bbe\u8ddf\u8e2a\u8ba2\u5355\u3001\u56de\u6b3e\u548c\u8d39\u7528\u7387",
  "2026H1 official report still needs exchange-level refresh in H^3; keep indirect AI-server memory-interface thesis under profit-quality verification": "2026H1 \u5b98\u65b9\u62a5\u544a\u4ecd\u9700\u5728 H^3 \u4e2d\u505a\u4ea4\u6613\u6240\u7ea7\u522b\u590d\u6838\uff1b\u7ee7\u7eed\u628a AI \u670d\u52a1\u5668\u5185\u5b58\u63a5\u53e3\u5047\u8bbe\u653e\u5728\u5229\u6da6\u8d28\u91cf\u95f8\u95e8\u4e0b",
  "Keep as core anchor; do not upgrade further until next revenue, margin, and delivery guidance confirm": "\u7ee7\u7eed\u4f5c\u4e3a\u6838\u5fc3\u951a\uff1b\u5728\u4e0b\u4e00\u6b21\u6536\u5165\u3001\u6bdb\u5229\u7387\u548c\u4ea4\u4ed8\u6307\u5f15\u786e\u8ba4\u524d\u4e0d\u518d\u4e0a\u8c03",
  "Keep as core ASIC/networking anchor; require Q3 AI revenue and customer deployment evidence": "\u7ee7\u7eed\u4f5c\u4e3a ASIC/\u7f51\u7edc\u6838\u5fc3\u951a\uff1b\u9700 Q3 AI \u6536\u5165\u548c\u5ba2\u6237\u90e8\u7f72\u8bc1\u636e",
  "Keep as HBM cycle monitor, not core anchor; watch ASP, inventory, and HBM long agreements": "\u4fdd\u6301\u4e3a HBM \u5468\u671f\u76d1\u63a7\uff0c\u4e0d\u5347\u4e3a\u6838\u5fc3\u951a\uff1b\u5173\u6ce8 ASP\u3001\u5e93\u5b58\u548c HBM \u957f\u534f",
  "Keep as A-share optical-module core supply-chain anchor; track 1.6T ramp, overseas revenue, and gross margin": "\u4fdd\u6301\u4e3a A \u80a1\u5149\u6a21\u5757\u6838\u5fc3\u4f9b\u5e94\u94fe\u951a\uff1b\u8ddf\u8e2a 1.6T \u653e\u91cf\u3001\u6d77\u5916\u6536\u5165\u548c\u6bdb\u5229\u7387",
  "Keep quality watch; upgrade only if active-device constraints ease and revenue re-accelerates": "\u4fdd\u6301\u8d28\u91cf\u8ddf\u8e2a\uff1b\u53ea\u6709\u6709\u6e90\u5668\u4ef6\u7ea6\u675f\u7f13\u89e3\u4e14\u6536\u5165\u518d\u52a0\u901f\u624d\u5347\u7ea7",
  "Keep as domestic-compute optionality; do not upgrade to core without sustained order and cash-flow proof": "\u4fdd\u6301\u4e3a\u56fd\u4ea7\u7b97\u529b\u671f\u6743\uff1b\u6ca1\u6709\u6301\u7eed\u8ba2\u5355\u548c\u73b0\u91d1\u6d41\u8bc1\u636e\u4e0d\u5347\u6838\u5fc3",
  "Keep as indirect beneficiary; track DDR5/MRCD penetration and whether profit growth keeps covering valuation": "\u4fdd\u6301\u95f4\u63a5\u53d7\u76ca\uff1b\u8ddf\u8e2a DDR5/MRCD \u6e17\u900f\u548c\u5229\u6da6\u589e\u957f\u80fd\u5426\u7ee7\u7eed\u8986\u76d6\u4f30\u503c",
  "CNInfo 2026 semiannual report": "\u5de8\u6f6e\u8d44\u8baf 2026 \u534a\u5e74\u62a5",
  "SEC Companyfacts / NVIDIA IR review queue": "SEC Companyfacts / NVIDIA IR \u590d\u6838\u961f\u5217",
  "Broadcom IR review queue": "Broadcom IR \u590d\u6838\u961f\u5217",
  "Micron IR / SEC Companyfacts review queue": "Micron IR / SEC Companyfacts \u590d\u6838\u961f\u5217",
  "SSE / company filing review queue": "\u4e0a\u4ea4\u6240 / \u516c\u53f8\u516c\u544a\u590d\u6838\u961f\u5217",
  "Research pool review keeps NVDA and Broadcom as core anchors, but next upgrade requires fresh mega-cap capex and delivery guidance": "\u7814\u7a76\u6c60\u590d\u6838\u540e\u7ee7\u7eed\u628a NVDA \u548c Broadcom \u4f5c\u4e3a\u6838\u5fc3\u951a\uff0c\u4f46\u4e0b\u4e00\u6b21\u4e0a\u8c03\u9700\u8981\u65b0\u7684\u5927\u5382 capex \u548c\u4ea4\u4ed8\u6307\u5f15",
  "Micron remains a monitor rather than a core anchor because HBM strength must be separated from memory-cycle pricing risk": "Micron \u4ecd\u4fdd\u6301\u4e3a\u76d1\u63a7\u5bf9\u8c61\u800c\u4e0d\u662f\u6838\u5fc3\u951a\uff0c\u56e0\u4e3a HBM \u5f3a\u5ea6\u5fc5\u987b\u548c\u5b58\u50a8\u5468\u671f\u4ef7\u683c\u98ce\u9669\u5206\u5f00",
  "Zhongji H1 delivery confirms mainline elasticity; TFC is quality-positive but less elastic, so the pair should be monitored separately": "\u4e2d\u9645\u65ed\u521b H1 \u5151\u73b0\u4e86\u4e3b\u7ebf\u5f39\u6027\uff1b\u5929\u5b5a\u901a\u4fe1\u8d28\u91cf\u4e3a\u6b63\u4f46\u5f39\u6027\u8f83\u5f31\uff0c\u4e24\u8005\u9700\u5206\u5f00\u8ddf\u8e2a",
  "No upgrade: keep order continuity, collections, expense ratio, and ecosystem repeat demand as the gate": "\u4e0d\u5347\u7ea7\uff1a\u7ee7\u7eed\u628a\u8ba2\u5355\u6301\u7eed\u6027\u3001\u56de\u6b3e\u3001\u8d39\u7528\u7387\u548c\u751f\u6001\u590d\u8d2d\u4f5c\u4e3a\u95f8\u95e8",
  "Post-FOMC and treasury monitor are now part of the valuation gate; high real yields still cap long-duration growth": "FOMC \u540e\u8ddf\u8e2a\u548c\u7f8e\u503a\u76d1\u63a7\u5df2\u7eb3\u5165\u4f30\u503c\u95f8\u95e8\uff1b\u9ad8\u5b9e\u9645\u5229\u7387\u4ecd\u538b\u5236\u957f\u4e45\u671f\u6210\u957f",
  "No upgrade: advanced-packaging heat still needs segment revenue and margin evidence from OSAT filings": "\u4e0d\u5347\u7ea7\uff1a\u5148\u8fdb\u5c01\u88c5\u70ed\u5ea6\u4ecd\u9700\u8981 OSAT \u516c\u544a\u91cc\u7684\u5206\u9879\u6536\u5165\u548c\u6bdb\u5229\u7387\u8bc1\u636e",
  "NVDA/AVGO/MU review, next official quarter as gate": "NVDA/AVGO/MU \u590d\u6838\uff0c\u4e0b\u4e00\u4e2a\u5b98\u65b9\u5b63\u5ea6\u4f5c\u4e3a\u95f8\u95e8",
  "ASP, inventory, HBM long agreements remain next checks": "ASP\u3001\u5e93\u5b58\u3001HBM \u957f\u534f\u4ecd\u662f\u4e0b\u4e00\u68c0\u67e5\u9879",
  "Official filing refresh still required for core upgrade": "\u5347\u7ea7\u6838\u5fc3\u524d\u4ecd\u9700\u5b98\u65b9\u62ab\u9732\u590d\u6838",
  "Keep as watch item until JCET/Huatian-style segment disclosure confirms revenue and margin elasticity": "\u4fdd\u6301\u89c2\u5bdf\uff0c\u76f4\u5230\u957f\u7535/\u534e\u5929\u7c7b\u5206\u9879\u62ab\u9732\u786e\u8ba4\u6536\u5165\u548c\u6bdb\u5229\u7387\u5f39\u6027",
  "Company filings / exchange disclosures": "\u516c\u53f8\u516c\u544a / \u4ea4\u6613\u6240\u62ab\u9732",
  "Real-rate and yen gate": "\u5b9e\u9645\u5229\u7387\u4e0e\u65e5\u5143\u95f8\u95e8",
  "QQQ / SOXX / ChiNext retest": "QQQ / SOXX / \u521b\u4e1a\u677f\u56de\u6d4b",
  "Market breadth expansion": "\u5e02\u573a\u5bbd\u5ea6\u6269\u6563",
  "Real rates and USD/JPY stopped pushing against risk assets": "\u5b9e\u9645\u5229\u7387\u548c USD/JPY \u5df2\u505c\u6b62\u5bf9\u98ce\u9669\u8d44\u4ea7\u65bd\u538b",
  "Pressure is easing but not clean enough to confirm reversal": "\u538b\u529b\u6709\u7f13\u89e3\uff0c\u4f46\u8fd8\u4e0d\u8db3\u4ee5\u5e72\u51c0\u786e\u8ba4\u53cd\u8f6c",
  "Real rates or USD/JPY still push against a full reversal": "\u5b9e\u9645\u5229\u7387\u6216 USD/JPY \u4ecd\u7136\u538b\u5236\u5168\u9762\u53cd\u8f6c",
  "Key growth indices are rebounding; still need a retest without breaking lows": "\u5173\u952e\u6210\u957f\u6307\u6570\u6b63\u5728\u53cd\u5f39\uff1b\u4ecd\u9700\u8981\u4e00\u6b21\u4e0d\u7834\u4f4e\u70b9\u7684\u56de\u6d4b",
  "Key growth indices have not yet provided enough retest evidence": "\u5173\u952e\u6210\u957f\u6307\u6570\u8fd8\u6ca1\u6709\u63d0\u4f9b\u8db3\u591f\u7684\u56de\u6d4b\u8bc1\u636e",
  "Participation is broad enough to support reversal confirmation": "\u53c2\u4e0e\u5bbd\u5ea6\u5df2\u8db3\u4ee5\u652f\u6301\u53cd\u8f6c\u786e\u8ba4",
  "Breadth is improving, but leadership is still not fully broad": "\u5bbd\u5ea6\u5728\u6539\u5584\uff0c\u4f46\u9886\u6da8\u8fd8\u672a\u5145\u5206\u6269\u6563",
  "Leadership remains narrow; rebound can still fail": "\u9886\u6da8\u4ecd\u504f\u7a84\uff0c\u53cd\u5f39\u4ecd\u53ef\u80fd\u5931\u8d25",
  "Watch 10Y real yield below 2.50% and USD/JPY stop rising": "\u89c2\u5bdf 10Y \u5b9e\u9645\u5229\u7387\u662f\u5426\u4f4e\u4e8e 2.50%\uff0c\u4ee5\u53ca USD/JPY \u662f\u5426\u505c\u6b62\u4e0a\u884c",
  "Track whether QQQ, SOXX, and ChiNext hold above the latest stress low after the bounce": "\u8ddf\u8e2a QQQ\u3001SOXX \u548c\u521b\u4e1a\u677f\u53cd\u5f39\u540e\u80fd\u5426\u5b88\u4f4f\u6700\u8fd1\u538b\u529b\u4f4e\u70b9",
  "Watch whether gains spread beyond AI and semiconductors with volume confirmation": "\u89c2\u5bdf\u6da8\u5e45\u80fd\u5426\u4ece AI/\u534a\u5bfc\u4f53\u6269\u6563\uff0c\u5e76\u83b7\u5f97\u6210\u4ea4\u91cf\u786e\u8ba4",
  "FRED / Yahoo Finance delayed FX": "FRED / Yahoo Finance \u5ef6\u8fdf\u6c47\u7387",
  "Market quotes / H^3 index tape": "\u5e02\u573a\u62a5\u4ef7 / H^3 \u6307\u6570\u6761",
  "Eastmoney sector heat / Nasdaq ETF quotes": "\u4e1c\u65b9\u8d22\u5bcc\u677f\u5757\u70ed\u5ea6 / Nasdaq ETF \u62a5\u4ef7",
  "HBM / DRAM": "HBM / DRAM",
  "Optical components": "\u5149\u5668\u4ef6",
  "AI server memory interface": "AI \u670d\u52a1\u5668\u5185\u5b58\u63a5\u53e3",
  "Evidence-discount zone: HBM demand is real, but memory-cycle risk keeps it outside core-anchor pricing": "\u8bc1\u636e\u6298\u4ef7\u533a\uff1aHBM \u9700\u6c42\u771f\u5b9e\uff0c\u4f46\u5b58\u50a8\u5468\u671f\u98ce\u9669\u4f7f\u5176\u8fd8\u6ca1\u8fdb\u5165\u6838\u5fc3\u951a\u5b9a\u4ef7",
  "FY2026 Q3 remains the validation anchor; ASP, inventory, and HBM long agreements decide whether low-position risk is turning": "FY2026 Q3 \u4ecd\u662f\u9a8c\u8bc1\u951a\u70b9\uff1bASP\u3001\u5e93\u5b58\u548c HBM \u957f\u534f\u51b3\u5b9a\u4f4e\u4f4d\u98ce\u9669\u662f\u5426\u8f6c\u5411",
  "FY2026 Q4 results, HBM mix, DRAM ASP, inventory, and customer long-term agreements": "FY2026 Q4 \u4e1a\u7ee9\u3001HBM \u7ed3\u6784\u3001DRAM ASP\u3001\u5e93\u5b58\u548c\u5ba2\u6237\u957f\u534f",
  "Upgrade only if ASP, inventory, HBM mix, and gross margin confirm together": "\u53ea\u6709 ASP\u3001\u5e93\u5b58\u3001HBM \u7ed3\u6784\u548c\u6bdb\u5229\u7387\u540c\u6b65\u786e\u8ba4\u624d\u5347\u7ea7",
  "Inventory builds, ASP weakens, or gross margin rolls over before HBM demand becomes durable": "\u5e93\u5b58\u4e0a\u5347\u3001ASP \u8f6c\u5f31\uff0c\u6216 HBM \u9700\u6c42\u53d8\u5f97\u53ef\u6301\u7eed\u524d\u6bdb\u5229\u7387\u5148\u56de\u843d",
  "Quality-discount zone: profit quality is solid, but revenue elasticity still trails the optical-module core": "\u8d28\u91cf\u6298\u4ef7\u533a\uff1a\u5229\u6da6\u8d28\u91cf\u624e\u5b9e\uff0c\u4f46\u6536\u5165\u5f39\u6027\u4ecd\u5f31\u4e8e\u5149\u6a21\u5757\u6838\u5fc3",
  "2026H1 revenue +15.15% YoY and net profit +33.92%; passive optical devices grew +77.00%": "2026H1 \u6536\u5165\u540c\u6bd4 +15.15%\uff0c\u51c0\u5229\u540c\u6bd4 +33.92%\uff1b\u65e0\u6e90\u5149\u5668\u4ef6\u589e\u957f +77.00%",
  "Q3 revenue re-acceleration, active-device constraint repair, high-margin component demand": "Q3 \u6536\u5165\u518d\u52a0\u901f\u3001\u6709\u6e90\u5668\u4ef6\u7ea6\u675f\u4fee\u590d\u3001\u9ad8\u6bdb\u5229\u5668\u4ef6\u9700\u6c42",
  "Upgrade only if revenue re-accelerates while gross margin and customer penetration stay strong": "\u53ea\u6709\u6536\u5165\u518d\u52a0\u901f\uff0c\u540c\u65f6\u6bdb\u5229\u7387\u548c\u5ba2\u6237\u6e17\u900f\u4fdd\u6301\u5f3a\u52bf\u624d\u5347\u7ea7",
  "High-margin component demand slows or active-device constraints keep revenue growth capped": "\u9ad8\u6bdb\u5229\u5668\u4ef6\u9700\u6c42\u653e\u7f13\uff0c\u6216\u6709\u6e90\u5668\u4ef6\u7ea6\u675f\u7ee7\u7eed\u538b\u5236\u6536\u5165\u589e\u957f",
  "Indirect-evidence discount zone: AI server memory-interface thesis is not priced like a direct core anchor": "\u95f4\u63a5\u8bc1\u636e\u6298\u4ef7\u533a\uff1aAI \u670d\u52a1\u5668\u5185\u5b58\u63a5\u53e3\u5047\u8bbe\u8fd8\u6ca1\u6709\u6309\u76f4\u63a5\u6838\u5fc3\u951a\u5b9a\u4ef7",
  "Keep the DDR5/MRCD thesis under official filing refresh and profit-quality verification": "\u628a DDR5/MRCD \u5047\u8bbe\u7ee7\u7eed\u653e\u5728\u5b98\u65b9\u62ab\u9732\u5237\u65b0\u548c\u5229\u6da6\u8d28\u91cf\u9a8c\u8bc1\u4e0b",
  "DDR5/MRCD penetration, server-chain revenue mix, gross margin, and profit growth": "DDR5/MRCD \u6e17\u900f\u3001\u670d\u52a1\u5668\u94fe\u6536\u5165\u7ed3\u6784\u3001\u6bdb\u5229\u7387\u548c\u5229\u6da6\u589e\u957f",
  "Upgrade only if official filings show AI-server interface revenue and profit transmission": "\u53ea\u6709\u5b98\u65b9\u62ab\u9732\u663e\u793a AI \u670d\u52a1\u5668\u63a5\u53e3\u6536\u5165\u548c\u5229\u6da6\u4f20\u5bfc\u624d\u5347\u7ea7",
  "Server-chain demand fails to enter financial statements or profit growth cannot cover valuation": "\u670d\u52a1\u5668\u94fe\u9700\u6c42\u6ca1\u6709\u8fdb\u5165\u8d22\u62a5\uff0c\u6216\u5229\u6da6\u589e\u957f\u4e0d\u80fd\u8986\u76d6\u4f30\u503c",
  "Gold": "\u9ec4\u91d1",
  "Silver": "\u767d\u94f6",
  ...
  "August 2026, +0.6pct MoM": "2026 \u5e74 8 \u6708\uff0c\u73af\u6bd4 +0.6pct",
  "August 2026 YoY": "2026 \u5e74 8 \u6708\u540c\u6bd4",
  "Jan-Aug 2026 YoY": "2026 \u5e74 1-8 \u6708\u540c\u6bd4",
  "August 2026, +0.57% MoM": "2026 \u5e74 8 \u6708\uff0c\u73af\u6bd4 +0.57%",
  ...
  "QoQ SAAR": "\u5b63\u8c03\u6298\u5e74\u7387",
  "Monthly change": "\u6708\u5ea6\u53d8\u5316",
  "Latest quarterly anchor; monthly data now decides whether Q3 can hold trend": "\u6700\u65b0\u5b63\u5ea6\u951a\u70b9\uff1b\u73b0\u5728\u7531\u6708\u5ea6\u6570\u636e\u5224\u65ad Q3 \u80fd\u5426\u5ef6\u7eed",
  "Still below 50, but production and new orders repaired": "\u4ecd\u4f4e\u4e8e 50\uff0c\u4f46\u751f\u4ea7\u548c\u65b0\u8ba2\u5355\u6709\u4fee\u590d",
  "Production remains firm; high-tech manufacturing is the stronger layer": "\u751f\u4ea7\u4ecd\u6709\u652f\u6491\uff1b\u9ad8\u6280\u672f\u5236\u9020\u4e1a\u662f\u66f4\u5f3a\u7684\u5c42",
  "Consumption remains the weak link despite service resilience": "\u670d\u52a1\u6709\u97e7\u6027\uff0c\u4f46\u6d88\u8d39\u4ecd\u662f\u5f31\u94fe\u6761",
  "Mild inflation; demand is not overheating": "\u6e29\u548c\u901a\u80c0\uff1b\u9700\u6c42\u5e76\u672a\u8fc7\u70ed",
  "Factory-gate inflation is firm; watch margin pressure": "\u5de5\u4e1a\u54c1\u51fa\u5382\u4ef7\u683c\u504f\u5f3a\uff1b\u9700\u5173\u6ce8\u5229\u6da6\u7387\u538b\u529b",
  "Investment contraction deepened; property remains the main drag": "\u6295\u8d44\u964d\u5e45\u6269\u5927\uff1b\u5730\u4ea7\u4ecd\u662f\u4e3b\u8981\u62d6\u7d2f",
  "Exports remain the strongest macro offset": "\u51fa\u53e3\u4ecd\u662f\u6700\u5f3a\u7684\u5b8f\u89c2\u5bf9\u51b2\u9879",
  "Reserve buffer rose as the dollar fell and asset prices diverged": "\u7f8e\u5143\u4e0b\u884c\u53e0\u52a0\u8d44\u4ea7\u4ef7\u683c\u53d8\u5316\uff0c\u5916\u50a8\u7f13\u51b2\u4e0a\u5347",
  ...
  "FOMC decision": "FOMC \u51b3\u8bae",
  "+25bp to 3.75%-4.00%": "\u52a0\u606f 25bp \u81f3 3.75%-4.00%",
  "Completed Sep 16, 2026": "2026 \u5e74 9 \u6708 16 \u65e5\u5df2\u5b8c\u6210",
  "Warsh-led FOMC raised the target range by 25bp; next read is whether 2Y/10Y yields, the dollar, USD/JPY, and gold absorb the hawkish rate path": "Warsh \u4e3b\u6301\u7684 FOMC \u5df2\u52a0\u606f 25bp\uff1b\u4e0b\u4e00\u6b65\u770b 2Y/10Y \u7f8e\u503a\u3001\u7f8e\u5143\u3001USD/JPY \u548c\u9ec4\u91d1\u5982\u4f55\u6d88\u5316\u9e70\u6d3e\u5229\u7387\u8def\u5f84",
  "NBS": "\u56fd\u5bb6\u7edf\u8ba1\u5c40",
  ...
  "Custom silicon / AI networking": "\u5b9a\u5236\u82af\u7247 / AI \u7f51\u7edc",
  "Optical modules / materials": "\u5149\u6a21\u5757 / \u6750\u6599",
  "AI server PCB": "AI \u670d\u52a1\u5668 PCB",
  "Advanced packaging / AI-HPC test": "\u5148\u8fdb\u5c01\u88c5 / AI-HPC \u6d4b\u8bd5",
  "Cloud storage / nearline HDD": "\u4e91\u5b58\u50a8 / \u8fd1\u7ebf HDD",
  "Advanced packaging / HPC": "\u5148\u8fdb\u5c01\u88c5 / HPC",
  "Underpriced candidate: margin repair and advanced-packaging demand are visible, but valuation has not fully rerated like AI infrastructure leaders": "\u4f4e\u4f30\u5019\u9009\uff1a\u5229\u6da6\u7387\u4fee\u590d\u548c\u5148\u8fdb\u5c01\u88c5\u9700\u6c42\u5df2\u80fd\u770b\u5230\uff0c\u4f46\u4f30\u503c\u8fd8\u6ca1\u6709\u50cf AI \u57fa\u5efa\u6838\u5fc3\u516c\u53f8\u90a3\u6837\u5145\u5206\u91cd\u4f30",
  "Q2 2026 gross margin reached 16.8%, up from 14.2% in Q1 and 12.0% YoY; record revenue and AI/HPC projects are advancing": "2026 Q2 \u6bdb\u5229\u7387\u8fbe 16.8%\uff0c\u9ad8\u4e8e Q1 \u7684 14.2% \u548c\u53bb\u5e74\u540c\u671f\u7684 12.0%\uff1b\u6536\u5165\u521b\u7eaa\u5f55\uff0cAI/HPC \u9879\u76ee\u6b63\u5728\u63a8\u8fdb",
  "Next earnings, AI/HPC package mix, utilization, gross margin, and capex return": "\u4e0b\u4e00\u6b21\u8d22\u62a5\u3001AI/HPC \u5c01\u88c5\u5360\u6bd4\u3001\u4ea7\u80fd\u5229\u7528\u7387\u3001\u6bdb\u5229\u7387\u548c capex \u56de\u62a5",
  "Promote only if revenue growth and gross margin hold while AI/HPC mix rises": "\u53ea\u6709\u6536\u5165\u589e\u957f\u548c\u6bdb\u5229\u7387\u4fdd\u6301\uff0c\u540c\u65f6 AI/HPC \u5360\u6bd4\u4e0a\u5347\u624d\u5347\u7ea7",
  "Utilization rolls over, gross margin falls back, or AI/HPC projects fail to scale": "\u4ea7\u80fd\u5229\u7528\u7387\u56de\u843d\u3001\u6bdb\u5229\u7387\u518d\u5ea6\u4e0b\u884c\uff0c\u6216 AI/HPC \u9879\u76ee\u65e0\u6cd5\u653e\u91cf",
  "Amkor Q2 2026 results / SEC filing": "Amkor 2026 Q2 \u4e1a\u7ee9 / SEC \u6587\u4ef6",
  "Underpriced only with discipline: cloud and AI storage demand are grounded, but the stock already reflects part of the recovery": "\u9700\u8981\u4e25\u683c\u4f30\u503c\u7eaa\u5f8b\u7684\u4f4e\u4f30\u5019\u9009\uff1a\u4e91\u548c AI \u5b58\u50a8\u9700\u6c42\u662f\u771f\u5b9e\u843d\u5730\u7684\uff0c\u4f46\u80a1\u4ef7\u5df2\u7ecf\u53cd\u6620\u4e86\u4e00\u90e8\u5206\u4fee\u590d",
  "FY2026 Q4 non-GAAP gross margin was 54.4%, with next-quarter guidance around 55.5%; cloud capacity demand remains the key proof": "FY2026 Q4 \u975e GAAP \u6bdb\u5229\u7387\u4e3a 54.4%\uff0c\u4e0b\u5b63\u5ea6\u6307\u5f15\u7ea6 55.5%\uff1b\u4e91\u5bb9\u91cf\u9700\u6c42\u4ecd\u662f\u5173\u952e\u8bc1\u636e",
  "Cloud revenue, nearline HDD demand, gross margin guide, long-term supply agreements, and inventory quality": "\u4e91\u6536\u5165\u3001\u8fd1\u7ebf HDD \u9700\u6c42\u3001\u6bdb\u5229\u7387\u6307\u5f15\u3001\u957f\u5355\u4f9b\u5e94\u534f\u8bae\u548c\u5e93\u5b58\u8d28\u91cf",
  "Promote only if cloud storage growth, margin durability, and demand visibility improve without valuation crowding": "\u53ea\u6709\u4e91\u5b58\u50a8\u589e\u957f\u3001\u6bdb\u5229\u7387\u6301\u7eed\u6027\u548c\u9700\u6c42\u80fd\u89c1\u5ea6\u63d0\u5347\uff0c\u4e14\u4f30\u503c\u4e0d\u62e5\u6324\u624d\u5347\u7ea7",
  "Cloud orders slow, pricing weakens, or gross margin guidance falls before AI storage demand broadens": "\u4e91\u8ba2\u5355\u653e\u7f13\u3001\u4ef7\u683c\u8f6c\u5f31\uff0c\u6216\u5728 AI \u5b58\u50a8\u9700\u6c42\u6269\u6563\u524d\u6bdb\u5229\u7387\u6307\u5f15\u4e0b\u884c",
  "Western Digital FY2026 Q4 results": "Western Digital FY2026 Q4 \u4e1a\u7ee9",
  "A-share underpriced candidate: advanced-packaging demand is improving, while the market still prices it more like a cyclical OSAT than a durable AI/HPC supplier": "A \u80a1\u4f4e\u4f30\u5019\u9009\uff1a\u5148\u8fdb\u5c01\u88c5\u9700\u6c42\u5728\u6539\u5584\uff0c\u4f46\u5e02\u573a\u4ecd\u66f4\u50cf\u6309\u5468\u671f\u5c01\u6d4b\u5382\u5b9a\u4ef7\uff0c\u800c\u4e0d\u662f\u6309\u7a33\u5b9a AI/HPC \u4f9b\u5e94\u5546\u5b9a\u4ef7",
  "2026H1 gross margin rose to 15.15%, up 1.68pct YoY; computing electronics growth is the demand bridge to AI/HPC": "2026H1 \u6bdb\u5229\u7387\u5347\u81f3 15.15%\uff0c\u540c\u6bd4\u63d0\u5347 1.68pct\uff1b\u8fd0\u7b97\u7535\u5b50\u589e\u957f\u662f\u8fde\u63a5 AI/HPC \u9700\u6c42\u7684\u6865",
  "Q3 filing, computing-electronics revenue mix, advanced-packaging utilization, gross margin, and cash-flow quality": "Q3 \u62ab\u9732\u3001\u8fd0\u7b97\u7535\u5b50\u6536\u5165\u7ed3\u6784\u3001\u5148\u8fdb\u5c01\u88c5\u4ea7\u80fd\u5229\u7528\u7387\u3001\u6bdb\u5229\u7387\u548c\u73b0\u91d1\u6d41\u8d28\u91cf",
  "Promote only if computing-electronics growth and margin expansion continue together": "\u53ea\u6709\u8fd0\u7b97\u7535\u5b50\u589e\u957f\u548c\u5229\u6da6\u7387\u6269\u5f20\u540c\u65f6\u5ef6\u7eed\u624d\u5347\u7ea7",
  "Advanced-packaging utilization weakens, gross margin reverses, or AI/HPC demand fails to lift profit quality": "\u5148\u8fdb\u5c01\u88c5\u4ea7\u80fd\u5229\u7528\u7387\u8f6c\u5f31\u3001\u6bdb\u5229\u7387\u56de\u843d\uff0c\u6216 AI/HPC \u9700\u6c42\u6ca1\u6709\u62c9\u52a8\u5229\u6da6\u8d28\u91cf",
  "JCET 2026 semiannual report / CNInfo": "\u957f\u7535\u79d1\u6280 2026 \u534a\u5e74\u62a5 / \u5de8\u6f6e",
  "Candidate discount zone: AI custom-silicon demand is visible, but execution and margin proof are still pending": "\u5019\u9009\u6298\u4ef7\u533a\uff1aAI \u5b9a\u5236\u82af\u7247\u9700\u6c42\u5df2\u80fd\u770b\u5230\uff0c\u4f46\u4ea4\u4ed8\u6267\u884c\u548c\u5229\u6da6\u7387\u8bc1\u636e\u8fd8\u9700\u8981\u9a8c\u8bc1",
  "Track whether custom AI silicon and electro-optics can translate into revenue acceleration and gross-margin repair": "\u8ddf\u8e2a\u5b9a\u5236 AI \u82af\u7247\u548c\u7535\u5149\u4e1a\u52a1\u80fd\u5426\u8f6c\u5316\u4e3a\u6536\u5165\u52a0\u901f\u4e0e\u6bdb\u5229\u7387\u4fee\u590d",
  "Next earnings, custom silicon backlog, AI networking orders, and data-center segment margin": "\u4e0b\u4e00\u6b21\u8d22\u62a5\u3001\u5b9a\u5236\u82af\u7247\u5728\u624b\u8ba2\u5355\u3001AI \u7f51\u7edc\u8ba2\u5355\u548c\u6570\u636e\u4e2d\u5fc3\u5206\u90e8\u5229\u6da6\u7387",
  "Promote only if revenue acceleration, backlog quality, and margin repair confirm together": "\u53ea\u6709\u6536\u5165\u52a0\u901f\u3001\u8ba2\u5355\u8d28\u91cf\u548c\u5229\u6da6\u7387\u4fee\u590d\u540c\u65f6\u786e\u8ba4\u624d\u5347\u7ea7",
  "Custom silicon ramp slips, networking demand weakens, or margin stays structurally pressured": "\u5b9a\u5236\u82af\u7247\u653e\u91cf\u63a8\u8fdf\u3001\u7f51\u7edc\u9700\u6c42\u8f6c\u5f31\uff0c\u6216\u5229\u6da6\u7387\u7ed3\u6784\u6027\u627f\u538b",
  "Marvell IR / SEC filing review queue": "Marvell IR / SEC \u6587\u4ef6\u590d\u6838\u961f\u5217",
  "Cyclical recovery candidate: AI optics are relevant, but debt, mix, and profitability keep it outside core-anchor status": "\u5468\u671f\u4fee\u590d\u5019\u9009\uff1aAI \u5149\u901a\u4fe1\u5177\u6709\u76f8\u5173\u6027\uff0c\u4f46\u503a\u52a1\u3001\u4e1a\u52a1\u7ed3\u6784\u548c\u76c8\u5229\u80fd\u529b\u8fd8\u4e0d\u8db3\u4ee5\u5347\u4e3a\u6838\u5fc3\u951a",
  "Watch datacom revenue, 800G/1.6T traction, free-cash-flow repair, and leverage reduction": "\u89c2\u5bdf\u6570\u636e\u901a\u4fe1\u6536\u5165\u3001800G/1.6T \u8fdb\u5c55\u3001\u81ea\u7531\u73b0\u91d1\u6d41\u4fee\u590d\u548c\u6760\u6746\u4e0b\u964d",
  "Next earnings, datacom order commentary, optical transceiver demand, and balance-sheet progress": "\u4e0b\u4e00\u6b21\u8d22\u62a5\u3001\u6570\u636e\u901a\u4fe1\u8ba2\u5355\u8868\u8ff0\u3001\u5149\u6a21\u5757\u9700\u6c42\u548c\u8d44\u4ea7\u8d1f\u503a\u8868\u6539\u5584",
  "Promote only if AI datacom growth and cash-flow repair appear in the same reporting window": "\u53ea\u6709 AI \u6570\u901a\u589e\u957f\u548c\u73b0\u91d1\u6d41\u4fee\u590d\u5728\u540c\u4e00\u62a5\u544a\u671f\u540c\u65f6\u51fa\u73b0\u624d\u5347\u7ea7",
  "Datacom growth slows, leverage remains heavy, or profitability fails to normalize": "\u6570\u636e\u901a\u4fe1\u589e\u901f\u653e\u7f13\u3001\u6760\u6746\u4ecd\u91cd\uff0c\u6216\u76c8\u5229\u80fd\u529b\u65e0\u6cd5\u6b63\u5e38\u5316",
  "Coherent IR / SEC filing review queue": "Coherent IR / SEC \u6587\u4ef6\u590d\u6838\u961f\u5217",
  "A-share supply-chain candidate: AI server PCB demand may have operating leverage, but valuation and customer mix need proof": "A \u80a1\u4f9b\u5e94\u94fe\u5019\u9009\uff1aAI \u670d\u52a1\u5668 PCB \u9700\u6c42\u53ef\u80fd\u6709\u7ecf\u8425\u6760\u6746\uff0c\u4f46\u4f30\u503c\u548c\u5ba2\u6237\u7ed3\u6784\u8fd8\u9700\u8981\u9a8c\u8bc1",
  "Track high-speed PCB orders, AI server customer penetration, capacity utilization, and gross-margin resilience": "\u8ddf\u8e2a\u9ad8\u901f PCB \u8ba2\u5355\u3001AI \u670d\u52a1\u5668\u5ba2\u6237\u6e17\u900f\u3001\u4ea7\u80fd\u5229\u7528\u7387\u548c\u6bdb\u5229\u7387\u97e7\u6027",
  "Q3 filing, AI server PCB shipment mix, capacity expansion progress, and customer concentration changes": "Q3 \u62ab\u9732\u3001AI \u670d\u52a1\u5668 PCB \u51fa\u8d27\u7ed3\u6784\u3001\u6269\u4ea7\u8fdb\u5ea6\u548c\u5ba2\u6237\u96c6\u4e2d\u5ea6\u53d8\u5316",
  "Promote only if AI server PCB revenue share rises while gross margin stays resilient": "\u53ea\u6709 AI \u670d\u52a1\u5668 PCB \u6536\u5165\u5360\u6bd4\u4e0a\u5347\u4e14\u6bdb\u5229\u7387\u4fdd\u6301\u97e7\u6027\u624d\u5347\u7ea7",
  "PCB price competition rises, capacity utilization falls, or AI-server mix fails to improve": "PCB \u4ef7\u683c\u7ade\u4e89\u52a0\u5267\u3001\u4ea7\u80fd\u5229\u7528\u7387\u4e0b\u964d\uff0c\u6216 AI \u670d\u52a1\u5668\u5360\u6bd4\u6ca1\u6709\u6539\u5584",
  "CNInfo / company filing review queue": "\u5de8\u6f6e / \u516c\u53f8\u6587\u4ef6\u590d\u6838\u961f\u5217"
};
...
const trValue = (value) => {
  ...
  return value
    ...
    .replace(/positive sectors/g, "\u4e2a\u6b63\u6536\u76ca\u677f\u5757");
};
...
function getFreshness(dateText) {
  const ts = Date.parse(dateText || "");
  if (!Number.isFinite(ts)) return { className: "stale", label: t("freshnessStale"), age: "" };
  const age = Math.max(0, Math.floor((Date.now() - ts) / 86400000));
  if (age <= 7) return { className: "fresh", label: t("freshnessFresh"), age: `${age}${t("freshnessDays")}` };
  if (age <= 30) return { className: "review", label: t("freshnessReview"), age: `${age}${t("freshnessDays")}` };
  return { className: "stale", label: t("freshnessStale"), age: `${age}${t("freshnessDays")}` };
}
...
function bottomStatusLabel(status) {
  if (status === "confirm") return t("bottomStatusConfirm");
  if (status === "risk") return t("bottomStatusRisk");
  return t("bottomStatusWatch");
}

function renderBottomReversalMonitor(data) {
  const target = document.getElementById("bottomReversalMonitor");
  if (!target) return;
  const items = data.bottomReversalMonitor || [];
  if (!items.length) {
    target.innerHTML = `<p>${t("unknown")}</p>`;
    return;
  }
  const confirmed = items.filter((item) => item.status === "confirm").length;
  const risk = items.filter((item) => item.status === "risk").length;
  const headline = confirmed >= 2
    ? t("bottomOverallConfirmed")
    : risk >= 2
      ? t("bottomOverallRisk")
      : t("bottomOverallWatch");
  target.innerHTML = `
    <div class="bottom-monitor-summary">
      <span>${t("bottomMonitorTitle")}</span>
      <strong>${headline}</strong>
    </div>
    <div class="bottom-monitor-grid">
      ${items.map((item) => `
        <article class="${item.status || "watch"}">
          <header>
            <span>${trValue(item.label)}</span>
            <b>${bottomStatusLabel(item.status)}</b>
          </header>
          <strong>${trValue(item.value)}</strong>
          <p>${trValue(item.read)}</p>
          <small>${t("bottomNextCheck")}: ${trValue(item.nextCheck)}</small>
        </article>
      `).join("")}
    </div>
  `;
...
function renderCompanies(companies) {
  document.getElementById("companyGrid").innerHTML = companies.map((item) => {
    ...
    const freshness = getFreshness(item.researchUpdatedAt);
    return `
      <article class="company-card">
        <header>
          ...
          <div class="company-tags">
            ...
            <span class="freshness-tag ${freshness.className}">${freshness.label}${freshness.age ? ` / ${freshness.age}` : ""}</span>
          </div>
        </header>
...
function renderUnderpricedCandidates(data) {
  const target = document.getElementById("underpricedCandidates");
  if (!target) return;
  const candidates = data.underpricedCoreCandidates || [];
  if (!candidates.length) {
    target.innerHTML = `<p>${t("unknown")}</p>`;
    return;
  }
  target.innerHTML = candidates.map((item) => `
    <article class="underpriced-card" style="--w:${clampScore(item.candidateScore)}%;--c:${barColor(clampScore(item.candidateScore))}">
      <header>
        <div>
          <span>${trValue(item.market)} / ${trValue(item.chain)}</span>
          <h3>${item.name}</h3>
          <small>${item.symbol}</small>
        </div>
        <b>${clampScore(item.candidateScore).toFixed(0)}</b>
      </header>
      <div class="underpriced-meter"><span></span></div>
      <p><strong>${t("underpricedPrice")}:</strong> ${trValue(item.pricePosition)}</p>
      <p><strong>${t("underpricedEvidence")}:</strong> ${trValue(item.evidence)}</p>
      <p><strong>${t("underpricedCatalyst")}:</strong> ${trValue(item.catalyst)}</p>
      <p><strong>${t("underpricedUpgrade")}:</strong> ${trValue(item.upgradeGate)}</p>
      <p><strong>${t("underpricedInvalidation")}:</strong> ${trValue(item.invalidation)}</p>
      <footer>
        <span>${t("underpricedBoundary")}</span>
        ${item.url ? `<a class="row-detail-button" href="${item.url}" target="_blank" rel="noreferrer">${t("underpricedSource")}</a>` : ""}
      </footer>
    </article>
  `).join("");
}
...
function renderResearchRows(companies) {
  document.getElementById("researchRows").innerHTML = companies.map((item) => `
    <tr data-symbol="${item.symbol}">
      ...
      <td>${trValue(item.status) || t("unknown")}<br><span class="tag">${trValue(item.lastDecision) || t("unknown")}</span><br><span class="freshness-tag ${getFreshness(item.researchUpdatedAt).className}">${getFreshness(item.researchUpdatedAt).label} / ${getFreshness(item.researchUpdatedAt).age || t("unknown")}</span></td>
  ...
  const cards = [
    {
      ...
      value: fomc ? trValue(fomc.value) : "+25bp to 3.75%-4.00%",
...
function render(data) {
  ...
  renderBottomReversalMonitor(data);
  renderFrameworkGrid();
  ...
  renderUnderpricedCandidates(data);
